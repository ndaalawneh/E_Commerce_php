...
<label for="user-name">User</label>
    ...
    <div class="input-group">
            <select class="form-control" id="inputGroupSelect04" name="user-gender">
...
<?php }else if($_GET["mode"] == "edit"){
    ...
    <div class="container " style="width: 70%; margin-top:5%;" >
        <form action="../insert.php" method="post" style="margin: 20px 0;" enctype="multipart/form-data">
            ...
            <br><br>
            <input type="text" class="form-control" id="user-gender"  name="user-gender" required value="<?php echo $data["gender"]?>">
            <br>
            <input type="text" class="form-control" id="user-birthday"  name="user-birthday" required value="<?php echo $data["birthday"]?>">
            <br>
