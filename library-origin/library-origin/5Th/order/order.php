                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-md">
                          ...
                          <tr>
                            ...
                            <td><a href="edit_order.php?order_id=<?php echo $value['order_id'] ."&mode=details";?>" class="btn btn-primary">Detail</a></td>
                            <td><a href="edit_order.php?order_id=<?php echo $value['order_id'] ."&mode=edit";?>" class="btn btn-secondary" style="height: 60%;" >Edit</a></td>
                            <td><button class="btn btn-danger" style="height: 60%;" data-toggle="modal" data-target="#confirm<?php echo $value['order_id'];?>">Delete</button></td>                          </tr>
                          <?php  } ?>
                          </table>
                          <?php }else{ ?> 
                            <tr> <td colspan="8">
                    ...
                    <div class="card-footer text-right">
                      <nav class="d-inline-block" style="display: flex;">
                        <ul class="pagination mb-0">
                          ...
                          <li><a href="edit_order.php?mode=add" class="btn btn-primary">Add</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
...
<div class="modal fade" id="confirm<?php echo $value['order_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="top: 27vh;">
      ...
      <div class="modal-footer">
        ...
        <a href="edit_order.php?order_id=<?php echo $value['order_id'] ."&mode=delete";?>" type="button" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
